...
3. **Deploy** to hardware with **`adb install -r app/build/outputs/apk/release/app-release.apk`** — **always prefer signed release** for installs on device.  
